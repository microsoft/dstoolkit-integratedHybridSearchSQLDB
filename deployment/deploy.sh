...
echo variable=${TF_VAR_end_ip_address}
terraform init
...
echo Searchkey=$AZURE_SEARCH_KEY
...
# export OPENAI_URI1="https://$(az location....).openai.azure.com/"
export OPENAI_URI="https://eastus.openai.azure.com/"
